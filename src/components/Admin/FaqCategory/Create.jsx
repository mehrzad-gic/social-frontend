...
import { create } from '../../../Controllers/FaqCategoryController';
...
const Create = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            if(response.success) {
                toast.success('faqCategory created successfully');
    ...
    return (
        <div className='container'>
            <div className='d-flex justify-content-between align-items-center mb-4'>
                <h1 className='text-success'>Create faqCategory</h1>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="mt-3">
                    ...
                    <textarea {...register('des',{required:true})} className='form-control' rows={5} name='des' id='des'></textarea>
                </div>
